...
/**
 * Created by songjian on 10/12/2018.
 */
public class ThreadPool {
    ...
    static class ThreadProcess {
        ...
        BlockingQueue blockingQueue = new LinkedBlockingDeque<Runnable>(4);
        ...
        public void process(String name) {
             ...
             * 特别注意下，任务是先在core执行，然后放入blockqueue，然后再启动线程直到max最后再触发policy
             */
            if (poolExecutor == null) {
                poolExecutor = new ThreadPoolExecutor(1, 3, 5, TimeUnit.SECONDS, blockingQueue, new ThreadPoolExecutor.AbortPolicy());
//                poolExecutor = (ThreadPoolExecutor) Executors.newFixedThreadPool(4);
            }
